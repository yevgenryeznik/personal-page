...
15+ years of research experience in mathematical physics and biostatistics which is summarized by 30+ scientific [publications](./publications.html) in mathematical and statistical journals.
...
::: g-col-4
![](./logo/uu-logo.jpg){width="13%"} **Jan. 2024 -- present**<br/> {{< fa location-dot >}} *Uppsala, Sweden*
:::

::: g-col-8
**Uppsala University, Department of Pharmacy**

***Researcher in Statistics and Pharmacometrics***

- Researching innovative statistical, pharmacometrics, and machine learning methods.

:::

::: g-col-4
![](./logo/janssen.png){width="19%"} **Jan. 2023 -- Jan. 2024**<br/> {{< fa location-dot >}} *Gothenburg, Sweden*
:::
...
- Applying statistical modeling to support clinical trial designs.
- Developing new methodologies to improve clinical trials efficiency.
- Researching innovative statistical, pharmacometrics, and machine learning methods.
...
- Applying statistical modeling to support early phases' clinical trial designs.
- Researching innovative statistical, pharmacometrics, and machine learning methods to improve the efficiency of clinical trials.
...
- Programming and validating (QC) STDM/ADaM datasets, tables, listings, and figures for clinical study reports (in SAS).
- Developing programming specifications according to the CDISC standards.
- Performing statistical analysis and modeling of clinical trial data.
...
- Teaching (full-time) various statistical and mathematical courses for undergraduate students.
- Researching the problems in mathematical physics and biostatistics.
