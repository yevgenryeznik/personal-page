...
The question is: _what is the scattered field_?
...
Here,
  ...
  - $H_0^{(2)}(z)$ is the [_Hankel function_](https://en.wikipedia.org/wiki/Bessel_function#Hankel_functions:_H(1)α,_H(2)α) of the $2^\text{nd}$ type and zero order.
